...
A ASP.Net Demo application written in VB demonstrating the WebScanning component - shows browser based scanning and viewing in the WebDocumentViewer  WebCapture API Reference
